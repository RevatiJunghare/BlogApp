...
const AllBlogs: React.FC<Props> = () => {
  ...
  const handleDashboardClick = () => {
    handleCloseUserMenu();
    setShowDashboard(true); // Show the Dashboard component when clicked
    navigate("/dashboard");
  };
  ...
  return (
    <WrapperBlog>
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Open settings">
                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                  ...
                  {/* Assuming loggedInUser is passed as a prop */}
                </IconButton>
              </Tooltip>
      ...
      {showDashboard && <Dashboard loggedInUser={loggedInUser}/>}
      <div className="blog-component">
        {data.length > 0 ? (
          data.map((el: any) => {
            return (
              <div key={el.blog_id} className="blog-box">
